//! Standard iPhone camera 12MP (4032x3024) still HEIC container fixture builder.

use super::box_builder::*;
use super::hevc_builder::*;

/// Builds a synthetic iPhone camera 12MP (4032x3024) still HEIC file container.
pub fn build_iphone_camera_12mp_heic() -> Vec<u8> {
    ...
    let ispe = make_ispe(4032, 3024);
    let iprp = make_iprp(&[ispe], &[(1, &[1])]);

    // Construct mdat payload
